...
Przykłady @Output() i  EventEmitter w Angularze. Przesyłanie róznych typów, obsługa eventów.
...
[https://stackblitz.com/github/ZacznijProgramowac/event-emitter-examples](https://stackblitz.com/github/ZacznijProgramowac/event-emitter-examples)
